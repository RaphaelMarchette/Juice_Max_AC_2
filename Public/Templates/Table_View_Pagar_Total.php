<?php
    ...
    $sql_6 = "SELECT SUM(valor) as subtotal FROM pagar_pedido";
    $sql_6 = $conexao->query($sql_6);
    $row = $sql_6->fetch_assoc();
    $soma_suco = $row['subtotal'];

    $sql_7 = "SELECT SUM(valor_acrescimo) as subtotalacrescimo FROM pagar_pedido";
...
<script src="Static_50/Scripts/View.js" defer></script>
